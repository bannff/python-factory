import { TypographyRenderer, ButtonRenderer, CardRenderer, MetricCardRenderer, TableRenderer, AlertRenderer, ProgressRenderer, FormRenderer, ListRenderer, ChartRenderer, ImageRenderer, TabsRenderer, BreadcrumbRenderer, DialogRenderer, ToastRenderer, PageRenderer, CodeRenderer, TimelineRenderer, TreeRenderer, CustomRenderer, SpacerRenderer, DividerRenderer, FallbackComponent, GraphViewerRenderer, ItemListRenderer, StatusDotRenderer, TrendBadgeRenderer, SparklineRenderer, DetailPanelRenderer, FilterBarRenderer, LineageRenderer, } from "./renderers";
/**
...
const _NORMALIZED_MAP = Object.fromEntries(Object.entries(COMPONENT_MAP).map(([k, v]) => [_norm(k), v]));
/**
