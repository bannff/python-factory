...
import type { BoundedGraphContext, GraphNode } from "./graph-types";
import {
...
export { colorForType } from "./graph-data-utils";
export type { GraphData, GraphStats } from "./graph-data-utils";
...
export function useGraphData(scoped = false) {
  const callTool = useBridge().callTool;
  ...
  }, [beginLoad, callTool, loadStats, scoped]);
