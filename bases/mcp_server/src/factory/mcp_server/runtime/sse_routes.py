"""SSE endpoint — streams tool invocation events on the unified server.
...
Pure transport shell — stream logic lives in factory.mcp_utils.tool_event_stream.
"""
...
def register_sse_routes(app) -> None:
    """Register SSE tool-stream routes on a Starlette app instance."""
